...
<body style="background-image: url(./images/contact-img.jpg);">
    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-up-container">
            <form id="form_reg" action="regis.php" method="post">
                <h2>Đăng ký</h2>
                ...
                <input type="submit" value="Đăng kí" class="btn-primary btn btn-block mt-4" name="btn-reg"
                    value="Đăng kí">
        ...
        <div class="form-container sign-in-container">
            <form action="./index.html" class="dangnhap">
                ...
                <input type="email" placeholder="Email" class="form-control" id="email" name="email" required />
                <input type="password" placeholder="Mật Khẩu" class="form-control" id="password" name="pasword"
                    required />
